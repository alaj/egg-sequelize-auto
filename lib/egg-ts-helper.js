...
function getModelFileStart(indentation, spaces, tableName) {
  ...
  fileStart += 'import {DataTypes as DataTypesType} from \'sequelize\';\n';
  fileStart += 'import {' + tableName + 'Instance, ' + tableName + 'Attribute} from \'./db\';\n\n';
  fileStart += "module.exports = function(app: Any) {\n";
  fileStart += spaces + "const DataTypes = app.Sequelize as DataTypesType\n";
